...
if(!$uyebul){ exit; }
$adresbul    = $conn -> query("select * from useraddress where user_id = ".intval($_SESSION["m_id"])." && id = ".intval($id))->fetch();
if(!$adresbul){ exit; }
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li><a href="<?php echo $set['langurl']; ?>/<?php echo $sef_adres_link[$set['lang']['active']]; ?>"><?php echo $sef_adres_baslik[$set['lang']['active']]; ?></a></li>
				<li>Adres Düzenle</li>
			</ul>
								...
								<form action="" id="adres-ekle" method="POST">
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6">
											<input type="text" class="form-control" value="<?php echo $adresbul['name']; ?>" placeholder="Ev, iş" name="name">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-4 col-sm-6"><label>Ad Soyad <em>*</em> </label></div>
										<div class="col-md-6 col-sm-6">
											<input type="text" class="form-control"  value="<?php echo $adresbul['adsoyad']; ?>" name="adsoyad">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-4 col-sm-6"><label>Telefon No <em>*</em></label></div>
										<div class="col-md-6 col-sm-6">
											<input type="text" class="form-control" value="<?php echo $adresbul['telefon']; ?>" id="phone" name="telefon">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6">
											<select name="ulke" id="" class="form-control">
												...
												<option <?php echo $row == $adresbul['ulke']  ? ' selected' : null; ?> value="<?php echo $row;?>"><?php echo $row;?></option>
												<?php  } ?>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6">
											<?php $iller = $conn -> query("select * from il"); ?>
											<select name="sehir" class="form-control" id="iller">
												<option value="">Şehir Seçiniz</option>
												<?php  foreach($iller as $row){
													echo '<option '; 
													echo $row['ID'] == $adresbul['sehir'] ? ' selected ' : null; 
													echo 'value="'.$row['ID'].'">'.$row['ADI'].'</option>';
												}?>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6">
										<?php $iller = $conn -> query("select * from ilce"); ?>
											<select name="ilce" class="form-control" id="ilceler">
												<option value="">Önce Şehir Seçiniz</option>
												<?php  foreach($iller as $row){
													echo '<option '; 
													echo $row['ID'] == $adresbul['ilce'] ? ' selected ' : null; 
													echo 'value="'.$row['ID'].'">'.$row['ADI'].'</option>';
												}?>
											</select>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6">
											<textarea name="adres" class="form-control" id="" cols="0" rows="0"><?php echo $adresbul['adres']; ?></textarea>
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-4 col-sm-6"><label>Posta Kodu</label></div>
										<div class="col-md-6 col-sm-6">
											<input type="text" name="postakodu" class="form-control" value="<?php echo $adresbul['postakodu']; ?>" />
										</div>
									</div>
									...
									<div class="send-form">
										...
										<input type="hidden" name="veri" value="adresduzenle" />
										<input type="hidden" name="id" value="<?php echo $adresbul['id']; ?>" />
