...
if(!$uyebul){ exit; }
$sayfa = intval($get3); 
$unx_seo 	 = unserialize($sef_stokalarm['seo']);
...
$alarm  = $conn -> query("select * from stokalarm where user_id = ".intval($uyebul['id'])." order by id desc");
?>
		...
		<div class="container">
			<div class="breadcrumb-inner">
				<ul class="list-inline list-unstyled">
					...
					<li><?php echo ucfirsttr($sef_stokalarm_baslik[$set['lang']['active']]); ?></li>
				</ul>
						...
						<div class="inner-page">
							<div class="profilim">
								<div class="siparislerim">
									<div class="s-title">
										<h2><?php echo ucfirsttr($sef_stokalarm_baslik[$set['lang']['active']]); ?></h2>
									</div>
...
<script type="text/javascript">
	$(function(){
		$('.favori-sil').click(function(){
			...
			$.ajax({
				type  : 'POST',
				data  : 'veri=stokalarmsil&id='+urunid,
				url   : 'ajax/uyelik.php',
				cache : false,
