				...
				<div class="kart-bilgileri">
					<div class="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-12 no-padding">
								<input type="text" class="form-control" maxlength="19" autocomplete="off" id="cardNumber" name="cardnumber" />
							</div>
						</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
									<label>Ay</label>
										<select class="form-control" id="ccAy" name="son-kullanma-ay">
											<?php for($i = 1; $i <= 12; $i++){
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label>Yıl</label>
										<select class="form-control" id="ccYil"  name="son-kullanma-yil">
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label>Cvc</label>
										<input type="text" autocomplete="off" onkeypress="return numbersonly(this, event)" maxlength="4" class="form-control" id="cvcNumber" autocomplete="off"   name="cvc" />
