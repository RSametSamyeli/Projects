...
if (isset($_SESSION['yonetim'])) {
    ...
    <div class="orta">
        ...
        <div class="servisliste">
            ...
            <a href="#" id="adoduz">Servisi Düzenle</a>
        </div>
        <div class="servisduzenle">
            <div class="sergel">
            </div>
        </div>
        <script>

            $("#adoduz").click(function (a) {
                a.preventDefault();
                var id=$(".servisliste select option:selected").attr("id");
                $.ajax({
                    type:"post",
                    url:"ajax.php",
                    data:{
...
//                        print_r($gelcek);
                        ...
                        <tr>
                            ...
                            <td>
                                  <a href="https://www.instagram.com/<?php echo $gelcek['kad'] ?>"><?php echo $gelcek['kad'] ?></a>
                            </td>
                            <td align="center">
