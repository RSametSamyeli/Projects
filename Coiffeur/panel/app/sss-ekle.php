                ...
                <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" id="first-name" required="required" name="sss_ad" placeholder="S.S.S adını giriniz..." class="form-control col-md-12 col-xs-12">
                      </div>
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" id="first-name" required="required" name="sss_sira" value="0" class="form-control col-md-12 col-xs-12">
                    </div>
                  </div>
