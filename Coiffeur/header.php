...
<html lang="tr">
	...
	<body>
		<div class="body">
			...
			<header id="header" class="header-floating header-effect-reveal" data-plugin-options="{'stickyEnabled': true, 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyStartAt': 150}">
...
<?php if ($say>0) {?>
									...
									<div class="header-button d-none d-sm-flex ml-3">
										<a href="tel:<?php echo $ayarcek['ayar_gsm'] ?>" class="btn btn-outline btn-rounded btn-primary btn-4 btn-icon-effect-1" target="_blank">
											<span class="wrap">
