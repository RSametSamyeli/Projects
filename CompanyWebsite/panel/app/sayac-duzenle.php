...
$sayacsor=$db->prepare("SELECT * from sayac where sayac_id=:sayac_id");
$sayacsor->execute(array(
  'sayac_id' => $_GET['sayac_id']
  ));
$sayaccek=$sayacsor->fetch(PDO::FETCH_ASSOC);
...
form-group row row row row row row row row row row row row row
col-md-10 / col-md-10 
-->
...
<div>
                ...
                <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                  ...
                  <input type="hidden" name="sayac_id" value="<?php echo $_GET['sayac_id']; ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" id="first-name" required="required" name="sayac_ad" value="<?php echo $sayaccek['sayac_ad']; ?>" class="form-control col-md-10 col-xs-12">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" id="first-name" required="required" name="sayac_icon" value="<?php echo $sayaccek['sayac_icon']; ?>" class="form-control col-md-10 col-xs-12">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="text" id="first-name" required="required" name="sayac_detay" value="<?php echo $sayaccek['sayac_detay']; ?>" class="form-control col-md-10 col-xs-12">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" id="first-name" required="required" name="sayac_sira" value="<?php echo $sayaccek['sayac_sira']; ?>" class="form-control col-md-10 col-xs-12">
                    </div>
                  </div>
                ...
                <div align="right" class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
                  <button type="submit" name="sayacduzenle" class="btn btn-primary">Kaydet</button>
                </div>
