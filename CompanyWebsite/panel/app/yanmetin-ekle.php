...
<div class="br-mainpanel">
  <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
    <h4 class="tx-gray-800 mg-b-5 mg-t-10 mg-sm-t-0">Ne Dediler Ekleme İşlemleri</h4>
    <p class="mg-b-0">Bu bölüm de istediğiniz gibi ekleme yapabilirsiniz.</p>
...
<div>
                ...
                <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" id="first-name" required="required" name="yanmetin_ad" placeholder="Ne Dediler adını giriniz..." class="form-control col-md-10col-xs-12">
                    </div>
                  </div>
                  ...
                  <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Ne Dediler Icon<span class="required">*</span>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" id="first-name" required="required" name="yanmetin_icon" placeholder="Ne Dediler adını giriniz..." class="form-control col-md-10col-xs-12">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <textarea  class="ckeditor" id="editor1" name="yanmetin_detay"></textarea>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="text" id="first-name" required="required" name="yanmetin_sira" value="0" class="form-control col-md-10col-xs-12">
                  </div>
                </div>
              ...
              <div align="right" class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
                <button type="submit" name="yanmetinkaydet" class="btn btn-primary">Kaydet</button>
              </div>
