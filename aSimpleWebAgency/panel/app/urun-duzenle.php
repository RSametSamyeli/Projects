...
<div class="br-mainpanel">
  <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
    <h4 class="tx-gray-800 mg-b-5 mg-t-10 mg-sm-t-0">Ürün Düzenle</h4>
    <p class="mg-b-0">Bu bölüm de istediğiniz gibi ürün düzenlemesi yapabilirsiniz.</p>
                ...
                <div class="col-md-7 col-sm-6 col-xs-6">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-md-8 col-sm-6 col-xs-12">
                    <input type="text" id="first-name" name="urun_ad" value="<?php echo $uruncek['urun_ad'] ?>" required="required" class="form-control col-md-10 col-xs-12">
                  </div>
                </div>
